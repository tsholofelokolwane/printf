 ...
 * @is_negative: Lists types of arguments
 * @ind: Types pf chars
 * @buffer: Array of buffer to handle print
 * @flags:  Counts number of active flags
 * @width: Width parameter
...
/**
 * write_num - Use a buffer to write number
...
/**
 * write_pntr - Write a memory address
 * @buffer: Chars array
 * @ind: Index the number starts in buffer
 * @length: Length of number
 * @width: Width parameter
 * @flags: Flags parameter
 * @padd: Char representing padding
 * @extra_c: Char representing extra char
 * @padd_start: Index which padding must start
 *
