...
int prnt_reverse(va_list types, char buffer[], int flags, int width, int precision, int size);

/*Function to print a string in rot 13*/
int prnt_rot13str(va_list types, char buffer[], int flags, int width, int precision, int size);
...
int write_pntr(char buffer[], int ind, int length, int width, int flags, char padd, char extra_c, int padd_start);
